...
function KovSpeedometer:draw()
    ...
    nvgBeginPath();
	nvgRect(-rectWidth/2-10,-rectHeight/2,rectWidth+20,rectHeight)
    nvgFillColor(BackgroundColor);
    nvgFill();

	-- Draw the first color
    nvgBeginPath();
	nvgRect(-rectWidth/2,-rectHeight/2+10,math.min(fillSpeed,gaugeMaxUPS),rectHeight-20)
    ...
    for i=0, gaugeMaxUPS, 100 do
        nvgBeginPath();
		nvgRect(-rectWidth/2+i-2,-rectHeight/2+10,4,rectHeight-20)
